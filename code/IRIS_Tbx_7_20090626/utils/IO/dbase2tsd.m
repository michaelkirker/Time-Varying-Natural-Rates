...
%
% The IRIS Toolbox 2007/10/16. Copyright 2007 Jaromir Benes. <a href="http://www.iris-toolbox.com">www.iris-toolbox.com</a>
%
...
for i = 1 : length(list)
  ...
  data(isnan(data)) = options.nan;
  data(isinf(data) & data > 0) = options.inf;
  data(isinf(data) & data < 0) = -options.inf;
