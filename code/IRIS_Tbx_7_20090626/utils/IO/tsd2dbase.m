...
while ischar(line)
   ...
   startdate = datcode(sscanf(info(4:9),'%g'),sscanf(info(10:11),'%g'),freq);
   enddate = datcode(sscanf(info(12:17),'%g'),sscanf(info(18:19),'%g'),freq);
   data = vec(sscanf([data{:}],'%f'));
